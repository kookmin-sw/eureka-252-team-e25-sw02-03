...
###✔️ 멘토링  
  ...
  - 대학원 방문 및 선배 만나기
    <br>
    🔹대학원 선배가 하고 계시는 연구 : 암호트래픽 연구
    <br>
    트래픽이란?
    <br>
    암호화된 패킷만 보고도 메신저앱, 네이버 TV, 유튜브 등 무슨 앱인지 알아차리는 연구
    <br>
    🔹대학원의 장점 : 기업과제를 통해 기업이 원하는 것을 알 수 있고, 부족한 점을 채울 수 있음
    <br>
    🔹추천하는 활동 : 학교에서 기업 인턴의 기회를 제공하는데 그런 것을 찾아서 하면 좋음
    <br>
    ...
    <br>
    논문을 읽을 때는 문라이트, 논문용 AI 등 사용할 수 있는 도구들이 있지만 그 내용이 맞는지 검증을 할 수 있을 정도의 영어 실력은 있어야 함
    🔹앞으로 열심히 공부하면 좋은 과목 : 운영체제, 데이터베이스, 컴퓨터네트워크

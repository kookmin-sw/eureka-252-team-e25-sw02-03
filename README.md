...
###✔️ 멘토링  
  - 내 지도 교수 함게 만나기
    ...
    <br>
    ▫️과거에는 수학이 특정 분야(ex그래픽스, 비전)에서만 많이 쓰였지만 현재는 인공지능이 큰 비중을 차지하게 됨
    <br>
     -> 인공지능은 선형대수를 기반으로 하기 때문에 열심히 공부해 놓으면 좋음
    <br>
    질문 2. 방학 동안 혼자서 전공 분야를 공부해 보고 싶은데, 어떻게 시작하면 좋을까요?
    <br>
    ▫️1학년은 너무 복잡하게 생각하지 말고 알고리즘 공부를 하는 것이 좋음(ex백준)
    <br>
    ▫️프로그램을 짜는 경험이 중요한데 AI 시대에는 큰 프로젝트를 혼자 처음부터 만들 필요는 없으며, 코드는 AI에게 만들어달라고 하고 그 코드를 분석하는 능력이 필요함
    <br>
     -> AI 구독 서비스(Claude Code)를 구독하고 프롬프트를 던져주면 대신 코드를 만들어 줌
    <br>
     -> AI가 만들어준 코드를 분석해 보고 이해가 안 되면 gpt에게 도움을 받을 수 있음
    <br>
    ...
    <br>
    ▫️웹 클라이언트 관련에서는 웹 클라이언트 컴퓨팅과 모바일 컴퓨팅이 가장 핵심
    ▫️서버 쪽은 웹 서버 컴퓨팅, 네트워크 과목을 들으면 좋고, 소프트웨어 디자인 패턴이나 소프트웨어 공학과 같은 과목 중 한두 개 들으면 좋음
    <br>
  - 대학원 방문 및 선배 만나기
    <br>

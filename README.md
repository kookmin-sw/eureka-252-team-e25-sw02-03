...
- 현재의 기술과 약 15년 전에 MIT에서 진행한 기술의 발전 모습은?
  ...
  <br>
  현재: 마커 없이 고정밀 핸드 트래킹 + 시선 + 음성
  <br>
  핀치/탭/드래그·스크롤 등 제스처 표준화
  <br>
  시선으로 가리키고 손으로 선택, 음성으로 명령
  <br>
  장치 형태(플랫폼)
  <br>
  ...
  <br>
  (소수) 스마트글래스/넥밴드: 특정 산업/특화 용도
  <br>
  <br>
  프로젝션 중심의 데모 단계에서 헤드셋·스마트폰 중심의 공간 컴퓨팅으로 진화하며, 일관된 표시와 손·시선·음성의 정밀 트래킹을 통해 실사용성과 확장성이 크게 높아졌다.
  <br>
  - 우리가 상상한 미래
  - 우리가 그리는 미래 그리고 나
